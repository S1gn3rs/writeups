...
void get_flag() {
    char flag[] = "\x12\x15\x15\x3a\x38\x2e\x34\x35\x34\x23\x24\x6f\x22\x2e\x2c\x6e\x36\x20\x35\x22\x29\x7e\x37\x7c\x31\x1e\x74\x11\x36\x20\x34\x36\x20\x38\x2a\x3c";
    for (int i = 0; i < 36; i++)
        flag[i] ^= 0x41;
    puts(flag);
}
